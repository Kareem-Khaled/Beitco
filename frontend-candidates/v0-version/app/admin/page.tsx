...
const allUsers = [
  { ...mockUsers[4], status: 'active', joinedAt: '2024-01-01', postsCount: 312 },
  { ...mockUsers[0], status: 'active', joinedAt: '2024-01-05', postsCount: 89 },
  { ...mockUsers[2], status: 'active', joinedAt: '2024-01-10', postsCount: 156 },
  { ...mockUsers[1], status: 'active', joinedAt: '2024-01-15', postsCount: 12 },
  { ...mockUsers[3], status: 'suspended', joinedAt: '2024-01-20', postsCount: 3 },
]
