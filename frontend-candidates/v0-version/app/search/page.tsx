...
export default function SearchPage() {
  ...
  const filteredListings = mockListings.filter(l => 
    l.title.includes(query) || l.location.includes(query)
  ).slice(0, 3)
  ...
  return (
    <AppShell showBackButton title="البحث" showBottomNav={false}>
      <div className="p-4">
        {/* Search Input */}
                    ...
                    {filteredGroups.map((group) => (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-muted-foreground">{group.members.toLocaleString()} عضو</p>
                        </div>
                      </Link>
                    ))}
                  </CardContent>
