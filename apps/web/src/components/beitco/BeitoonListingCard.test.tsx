...
describe("BeitoonListingCard", () => {
  it("renders the title, area, and type", () => {
    render(<BeitoonListingCard p={base} />);
  ...
  it("shows the formatted price with the monthly suffix", () => {
    const { container } = render(<BeitoonListingCard p={base} />);
  ...
  it("renders the gender policy chip for female-only", () => {
    render(<BeitoonListingCard p={{ ...base, rentToGender: "female_only" }} />);
