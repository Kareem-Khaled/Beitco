    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          title:
            "group-[.toast]:!text-[15px] group-[.toast]:font-semibold group-[.toast]:leading-snug",
          description:
            "group-[.toast]:!text-sm group-[.toast]:!text-muted-foreground group-[.toast]:leading-relaxed",
