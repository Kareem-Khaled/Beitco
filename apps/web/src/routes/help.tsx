...
const faqs = [
  {
    ...
    a: "اضغط «دوّر» في الأعلى، اكتب المنطقة أو اسم المكان، واستخدم الفلاتر (النوع، السعر، السراير الفاضية). لما تلاقي مكان عاجبك، اضغط عليه تشوف التفاصيل كاملة.",
  },
  {
  ...
  {
    q: "إزاي أعرض مكاني؟",
    a: "اضغط «اعرض مكانك»، واتبع الخطوات: النوع، المكان، عدد السراير، الصور، السعر، والمميزات. الموضوع بياخد دقايق وبعدها إعلانك يظهر للناس.",
  },
  {
    q: "بيتكو بتاخد عمولة؟",
    a: "اعرض مكانك والتصفّح مجاني تماماً. بنوفّر خدمات إضافية لأصحاب البيوت اللي عايزين وصول أوسع، بس الأساسيات مجانية.",
  },
  {
