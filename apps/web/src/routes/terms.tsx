...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "الشروط والأحكام — بيتكو" },
      {
        name: "description",
        content: "شروط استخدام بيتكو — بوضوح وبساطة.",
      },
    ],
  }),
  component: TermsPage,
...
const sections: { title: string; body: string }[] = [
  {
    title: "بيتكو منصة، مش وسيط",
    body: "بيتكو بتوصّل بين أصحاب الشقق والساكنين. إحنا مش طرف في أي عقد إيجار أو بيع — الاتفاق النهائي بينك وبين الطرف التاني.",
  },
  {
  ...
  {
    title: "المدفوعات",
    body: "بيتكو دلوقتي مجانية للساكنين وللإعلان الأساسي. أي رسوم مستقبلية (زي اشتراك التوثيق) هتكون واضحة قبل ما تدفع أي حاجة.",
  },
  {
      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-12 sm:px-6 lg:px-8">
        <header className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm text-muted-foreground">
            باستخدامك بيتكو، إنت موافق على الشروط دي. كتبناها بوضوح من غير لفّ ودوران.
          </p>
        </header>
