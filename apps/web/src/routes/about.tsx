      ...
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        <section className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-muted-foreground">
            دوّرت على سكن في مصر قبل كده؟ تعرف القصة — صور مش حقيقية، أسعار بتتغيّر، ومحدش
            بيقولك الحقيقة عن المكان قبل ما تروح. بيتكو اتعملت عشان تحل ده. إحنا منصة سكن
            بتأجّر على مستوى السرير، مبنية على الثقة والشفافية من أول يوم.
          </p>
        </section>
