                  ...
                  >
                    ...
                    <div className="p-3">
                      ...
                      <Button
                        ...
                        className={`w-full mt-2 ${!joinedGroups.has(group.id) ? 'bg-green-600 hover:bg-green-700 text-white' : ''}`}
                        onClick={(e) => {
                          e.preventDefault()
                          toggleJoin(group.id)
                        }}
                ...
                {mockGroups.map((group) => (
                  ...
                  >
                    ...
                    <Button
                      size="sm"
                      variant={joinedGroups.has(group.id) ? "outline" : "default"}
                      className={`flex-shrink-0 self-center ${!joinedGroups.has(group.id) ? 'bg-green-600 hover:bg-green-700 text-white' : ''}`}
